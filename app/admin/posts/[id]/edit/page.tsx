...
export default function EditPostPage({ params }: { params: { id: string } }) {
  ...
  if (loading) return <div className="text-white text-center py-20">Loading Post Assets...</div>;
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-3xl font-heading font-bold text-white uppercase">Edit Post</h1>
      </div>
