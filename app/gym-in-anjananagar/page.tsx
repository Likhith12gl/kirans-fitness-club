...
export const metadata: Metadata = {
  ...
  description: "Looking for the best gym in Anjananagar? Kiran's Fitness Club offers world-class equipment, certified personal trainers, and high-energy group fitness classes. Join today!",
};
