            ...
            <div className="space-y-6 mb-10">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-text-secondary">9, 10, Shivakrupa Complex, E W College Main Rd,<br/>Bharath Nagar, Bedarahalli, Bengaluru — 560091</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-surface rounded-full flex shrink-0 items-center justify-center text-accent">
                ...
                <div>
                  ...
                  <p className="text-text-secondary">+91 81793 76067</p>
                </div>
              </div>
            </div>

            <Link href="https://wa.me/918179376067?text=Hi%2C%20I%27d%20like%20to%20know%20more%20about%20joining%20Kiran%27s%20Fitness%20Club%21" target="_blank" rel="noopener noreferrer" className="btn-primary inline-flex items-center gap-2">
